...
$actividades_p = strip_tags($dataObject->actividades_propuestas);
$actividades_d = strip_tags($dataObject->actividades_desarrolladas);
...
if ($numero_contrato == "") {
    ...
    try {
        ...
        if ($control == "No") {
            ...
            $rta1 = Cumplimiento_objetivosFacade::insert($objetivos_propuestos, $actividades_p, $actividades_d, $logros_alcanzados, $porcentaje_cumplimiento, $id_solicitud2);
            http_response_code(200);
            echo "{\"mensaje\":\"Se ha registrado exitosamente\",\"id\":\"{$id_solicitud2}\"}";
        } else {
            $rta1 = Cumplimiento_objetivosFacade::insert($objetivos_propuestos, $actividades_p, $actividades_d, $logros_alcanzados, $porcentaje_cumplimiento, $id_solicitud);
            http_response_code(200);
