...
if ($numero_contrato == "") {
    ...
    try {
        ...
        if ($control == "No") {
            ...
            $rta1 = InvestigadorFacade::insertFOIN15($nombre_investigador, $tipo_investigador, $horas_semana, $id_solicitud2);
            http_response_code(200);
            echo "{\"mensaje\":\"Se ha registrado exitosamente\",\"id\":\"{$id_solicitud2}\"}";
        } else {
            $rta1 = InvestigadorFacade::insertFOIN15($nombre_investigador, $tipo_investigador, $horas_semana, $id_solicitud);
            http_response_code(200);
