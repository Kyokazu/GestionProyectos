...
class PersonaFacade {
   ...
   * @param perfiles_id
   */
  public static function insert( $id,  $nombre,  $telefono,  $correo,  $perfiles_id){
      $persona = new Persona();
      $persona->setId($id); 
  ...
  public static function select2($correo){
      $persona = new Persona();
      $persona->setCorreo($correo); 

     $FactoryDao=new FactoryDao(self::getGestorDefault());
     $personaDao =$FactoryDao->getpersonaDao(self::getDataBaseDefault());
     $result = $personaDao->select2($persona);
     $personaDao->close();
     return $result;
  }
   ...
   */
  public static function listAll2($correo){
     $FactoryDao=new FactoryDao(self::getGestorDefault());
     $personaDao =$FactoryDao->getpersonaDao(self::getDataBaseDefault());
     $result = $personaDao->listAll2($correo);
     $personaDao->close();
     return $result;
  }
