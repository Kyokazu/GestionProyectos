...
class Tipo_publicacionesFacade {
    ...
    public static function update($id, $descripcion, $estado) {
        ...
        $FactoryDao = new FactoryDao(self::getGestorDefault());
        $tipo_publicacionesDao = $FactoryDao->gettipo_publicacionesDao(self::getDataBaseDefault());
        $tipo_publicacionesDao->update($tipo_publicaciones);
        $tipo_publicacionesDao->close();
    }
    ...
    public static function update2($id) {
        ...
        $FactoryDao = new FactoryDao(self::getGestorDefault());
        $tipo_publicacionesDao = $FactoryDao->gettipo_publicacionesDao(self::getDataBaseDefault());
        $tipo_publicacionesDao->update2($tipo_publicaciones);
        $tipo_publicacionesDao->close();
    }
