...
interface IEstado_proyectoDao {
  ...
  public function select($estado_proyecto);
    /**
     * Lista todos los objetos Estado_proyecto en la base de datos.
     * @return Array<Estado_proyecto> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
