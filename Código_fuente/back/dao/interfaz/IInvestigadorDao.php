...
interface IInvestigadorDao {
  ...
  public function select($investigador);
    /**
     * Lista todos los objetos Investigador en la base de datos.
     * @return Array<Investigador> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
