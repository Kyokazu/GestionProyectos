...
class ProyectosDao implements IProyectosDao {
    ...
    public function select($proyectos) {
        ...
        try {
            $sql = "SELECT `id`, `titulo`, `investigador`, `tipo_proyecto_id`, `tiempo_ejecucion`, `fecha_ini`, `resumen`, `obj_general`, `resultados`, `costo_valor`, `producto`, `semillero_id`"
                    . "FROM `proyectos`"
                    . "WHERE `id`='$id'";
    ...
    public function selectTitulo($id) {
