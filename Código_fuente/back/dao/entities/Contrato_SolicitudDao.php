...
class Contrato_SolicitudDao implements IContratoDao {
    ...
    public function insert($contrato) {
        ...
        try {
            $sql = "INSERT INTO `contrato`( `id`, `numero_contrato`, `acta_comite`, `valor_financiado`, `fecha_inicio`, `fecha_suspension`, `fecha_reinicio`, `prorroga`, `fecha_terminacion`, `tiempo_ejecucion`, `id_informe_gestion_financiado`)"
                    . "VALUES ('$id','$numero_contrato','$acta_comite','$valor_financiado','$fecha_inicio','$fecha_suspension','$fecha_reinicio','$prorroga','$fecha_terminacion','$tiempo_ejecucion','$id_informe_gestion_financiado')";
