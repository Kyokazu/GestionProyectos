...
function iniciarTabla() {
    ...
    $("#listadoTablaFO_IN_12").DataTable({
        responsive: true,
        ordering: true,
        paging: true,
        searching: true,
...
function listadoSolicitudes(solicitudes) {
    let tabla = $("#listadoTablaFO_IN_12").DataTable();
    tabla.data().clear();
...
function registrar_FO_IN_12() {


    let ordenes = {
        nombre_tutor: $('#txt_Nombre_Tutor').val(),
        nombre_joven: $('#txt_Nombre_proyecto').val(),
    };
    Utilitario.agregarMascara();
    fetch("../../back/controller/Cumplimiento_acompanamientoController_Insert.php", {
        method: "POST",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
