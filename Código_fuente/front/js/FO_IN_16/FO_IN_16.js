...
function iniciarTabla() {
    ...
    $("#listadoTablaFO_IN_16").DataTable({
        responsive: true,
        ordering: true,
        paging: true,
        searching: true,
...
function obtenerDatos() {
    ...
    fetch("../../back/controller/Informe_gestion_jovenesController_List.php", {
        method: "GET",
        headers: {
...
function listadoSolicitudes(solicitudes) {
    let tabla = $("#listadoTablaFO_IN_16").DataTable();
    tabla.data().clear();
...
function registrar_FO_IN_16() {

    let ordenes = {

        facultad: $('#txt_Numero_Contrato').val(),
        grupo_investigacion: $('#txt_Grupo_investigación').val(),
        departamento: $('#combo_proyectos').val(),
        nombre_tutor: $('#id_solicitud_hidden').val(),
        control: $('#control').val(),
        linea_investigacion: selected,
        nombre_joven: $('#txt_Acta_Comite').val(),
...
function registrar_Actividad_FO_IN_16() {


    let ordenes = {

        facultad: $('#txt_Facultad').val(),
        id_proyecto: $('#id_proyecto_hidden').val(),
        id_solicitud: $('#id_solicitud_hidden').val(),
        grupo_investigacion: $('#txt_Grupo_Investigacion').val(),
        departamento: $('#txt_Departamento').val(),
        nombre_tutor: $('#txt_Nombre_Tutor').val(),
        control: $('#control').val(),
        linea_investigacion: $('#txt_Lineas_Investigacion').val(),
        nombre_joven: $('#txt_Nombre_Joven').val(),
        convenio_colciencias: $('#txt_Convenio_Colciencias').val(),
        numero_convocatoria: $('#txt_Numero_concatoria_jovenes').val(),
        periodo_tutoria: $('#txt_Periodo_Tutoria').val(),
        combo_semestre: $('#combo_semestre').val(),
        actividades_desarrolladas: $('#txt_Actividades_Desarrolladas').val(),
        productos_alcanzados: $('#txt_Productos_Alcanzados').val(),

    };
    Utilitario.agregarMascara();
    fetch("../../back/controller/Informe_gestion_jovenesController_Insert.php", {
        method: "POST",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
