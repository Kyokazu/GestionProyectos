...
function iniciarTabla() {
    ...
    $("#listadoTablaFO_IN_16_RF").DataTable({
        responsive: true,
        ordering: true,
        paging: true,
        searching: true,
...
//            alert(data.descripcion);
    ...
    $("#tablaDatosProyecto16RF").DataTable({
        responsive: true,
        ordering: true,
        paging: false,
        searching: false,
    ...
    $("#tablaDatosInvolucrados16RF").DataTable({
        responsive: true,
        ordering: true,
        paging: false,
        searching: false,
...
function listadoSolicitudes(solicitudes) {
    let tabla = $("#listadoTablaFO_IN_16_RF").DataTable();
    tabla.data().clear();
...
function obtenerDatosCombo() {
    let ordenes = {
        id_solicitud: $('#combo_solicitudesRF16').val()
    };
    Utilitario.agregarMascara();
...
function listadoSolicitudesComboTabla1(solicitud) {
    let tabla = $("#tablaDatosProyecto16RF").DataTable();
    tabla.data().clear();
    tabla.rows.add(solicitud).draw();
}
...
function listadoSolicitudesComboTabla2(solicitud) {
    let tabla = $("#tablaDatosInvolucrados16RF").DataTable();
    tabla.data().clear();
    tabla.rows.add(solicitud).draw();
}
...
function construirSelectProyectos(pro) {
    $("#combo_solicitudesRF16").empty();
    let input = $("#combo_solicitudesRF16");
    ...
    for (let index = 0; index < pro.length; index++) {
        ...
        if (gpI.vb_representante_facultad === "En trámite") {
...
function aprobarSolicitudHorasTutor_RF() {
    ...
    Utilitario.agregarMascara();
    fetch("../../back/controller/Informe_gestion_jovenesController_Update_RF.php", {
        method: "POST",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
...
function rechazarSolicitudHorasTutor_RF() {
    ...
    console.log("envio del la data ", ordenes);
    Utilitario.agregarMascara();
    fetch("../../back/controller/Informe_gestion_jovenesController_Update_RF2.php", {
        method: "POST",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
