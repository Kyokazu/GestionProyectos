...
function iniciarTabla() {
    $("#listadoTablaFO_IN_10").DataTable({
        responsive: true,
        ordering: true,
        paging: true,
        searching: true,
...
//            alert(data.descripcion);
    ...
    $("#tablaComboSeleccionado").DataTable({
        responsive: true,
        ordering: true,
        paging: true,
        searching: true,
...
function listadoSolicitudes(solicitudes) {
    let tabla = $("#listadoTablaFO_IN_10").DataTable();
    tabla.data().clear();
...
function obtenerDatosCombo() {
    let ordenes = {
        id_solicitud: $('#combo_solicitudesRF10').val()
    };
    Utilitario.agregarMascara();
...
function cargar_solicitudes() {
    ...
    fetch("../../back/controller/Concepto_cumplimientoController_List_Combo.php", {
        method: "GET",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
...
function construirSelectProyectos(pro) {
    $("#combo_solicitudesRF10").empty();
    let input = $("#combo_solicitudesRF10");
...
function aprobarConceptoCumplimiento_RF10() {
    ...
    Utilitario.agregarMascara();
    fetch("../../back/controller/Concepto_cumplimientoController_Update_RF.php", {
        method: "POST",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
...
function rechazarConceptoCumplimiento_RF10() {
    ...
    console.log("envio del la data ", ordenes);
    Utilitario.agregarMascara();
    fetch("../../back/controller/Concepto_cumplimientoController_Update_RF2.php", {
        method: "POST",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
