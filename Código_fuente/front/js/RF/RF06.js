...
function iniciarTabla() {
    $("#listadoTablaFO_IN_06_RF").DataTable({
        responsive: true,
        ordering: true,
        paging: true,
        searching: true,
...
function obtenerDatos() {
    ...
    fetch("../../back/controller/Solicitud_horas_financiado_List_RF.php", {
        method: "GET",
        headers: {
...
function listadoSolicitudes(solicitudes) {
    let tabla = $("#listadoTablaFO_IN_06_RF").DataTable();
    tabla.data().clear();
...
function obtenerDatosCombo() {
    let ordenes = {
        id_solicitud: $('#combo_solicitudesRF06').val()
    };
    Utilitario.agregarMascara();
...
function construirSelectProyectos(pro) {
    $("#combo_solicitudesRF06").empty();
    let input = $("#combo_solicitudesRF06");
...
function aprobarSolicitudHoras_RF06() {
    ...
    Utilitario.agregarMascara();
    fetch("../../back/controller/Solicitud_horas_financiado_Update_RF.php", {
        method: "POST",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
...
function rechazarSolicitudHoras_RF06() {
    ...
    console.log("envio del la data ", ordenes);
    Utilitario.agregarMascara();
    fetch("../../back/controller/Solicitud_horas_financiado_Update_RF2.php", {
        method: "POST",
        headers: {
            Accept: "application/json",
            "Content-Type": "application/json",
